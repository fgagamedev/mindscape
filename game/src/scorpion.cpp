...
void Scorpion::initialize_audio_effects(){
  ...
  "attack",
  ASSETS_PATH("/audios/effects_songs/ataque_insetos.wav"), engine::Audio::CHUNK);
  scorpion_attacking->set_duration(0.7);

  engine::Audio * scorpion_on_attack = new engine::Audio(
  "hit_me",
  ASSETS_PATH("/audios/effects_songs/inseto_apanhando.wav"), engine::Audio::CHUNK);
...
void Scorpion::initialize_animations(){
    engine::Animation* walking_left_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_walking_left.png"),
      1, 5, 0.9, "LEFT"
    );

    engine::Animation* walking_right_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_walking_right.png"),
      1, 5, 0.9, "RIGHT"
    );

    engine::Animation* idle_left_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_idle_left.png"),
      1, 2, 0.9, "LEFT"
    );

    engine::Animation* idle_right_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_idle_right.png"),
      1, 2, 0.9, "RIGHT"
    );

    engine::Animation* attacking_left_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_attacking_left.png"),
      1, 5, 0.7, "LEFT"
    );

    engine::Animation* attacking_right_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_attacking_right.png"),
      1, 5, 0.7, "RIGHT"
    );

    engine::Animation* on_attack_left_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_on_attack_left.png"),
      1, 2, 0.8, "LEFT"
    );

    engine::Animation* on_attack_right_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_on_attack_right.png"),
      1, 2, 0.8, "RIGHT"
    );

    engine::Animation* dying_left_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_dying_left.png"),
      1, 5, 0.8, "LEFT"
    );
    ...
    engine::Animation* dying_right_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/scorpion/scorpion_dying_right.png"),
      1, 5, 0.8, "RIGHT"
    );
