...
void HudFox::initialize_audio_effects(){
  ...
  "heart", ASSETS_PATH("/audios/effects_songs/mindscape_heart.wav"), engine::Audio::CHUNK);
...
void HudFox::initialize_animations(){
  engine::Animation* fox_zero_star = create_animation(
      ASSETS_PATH("/images/sprites/hud/hud_fox_0.png"),
      1,1,0.9, "RIGHT"
      );

  engine::Animation* fox_one_star = create_animation(
      ASSETS_PATH("/images/sprites/hud/hud_fox_1.png"),
      1,1,0.9, "RIGHT"
      );

  engine::Animation* fox_two_star = create_animation(
      ASSETS_PATH("/images/sprites/hud/hud_fox_2.png"),
      1,1,0.9, "RIGHT"
      );

  engine::Animation* fox_three_star = create_animation(
      ASSETS_PATH("/images/sprites/hud/hud_fox_3.png"),
      1,1,0.9, "RIGHT"
      );

  engine::Animation* fox_three_star_fading = create_animation(
      ASSETS_PATH("/images/sprites/hud/hud_fox_3_animation.png"),
      1,4,1.0, "RIGHT"
      );
