...
void Clown::initialize_animations(){
  engine::Animation* idle_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/clown/clown_idle.png"),
      1, 15, 3.0, "LEFT"
      );
  ...
  engine::Animation* on_attack_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/clown/clown_on_attack.png"),
      1, 4, 0.4, "LEFT"
      );
  ...
  engine::Animation* dying_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/clown/clown_dying.png"),
      1, 5, 0.9, "LEFT"
      );
  ...
  engine::Animation* attacking_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/clown/clown_attacking.png"),
      1, 6, 1.5, "LEFT"
      );
  ...
  engine::Animation* idle_vulnerable_animation = create_animation(
      ASSETS_PATH("/images/sprites/enemies/clown/clown_vulnerable_idle.png"),
      1, 15, 3.0, "LEFT"
      );
